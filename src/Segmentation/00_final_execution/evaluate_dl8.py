...
# python evaluate_dl8.py -input_model /home/shared/models/spiculation_v1.hdf5 -input_data /media/shared/datasets/LUNA/preprocessed_extra_features/ -output_csv /home/shared/output/luna_dl8_v1.csv
# python evaluate_dl8.py -input_model /home/shared/models/spiculation_v1.hdf5 -input_data /media/shared/datasets/ISBI/preprocessedNew/ -output_csv /home/shared/output/isbi_dl8_v1.csv
# python evaluate_dl8.py -input_model /home/shared/models/spiculation_v1.hdf5 -input_data /media/shared/datasets/DSB/preprocessed_s1/ -output_csv /home/shared/output/dsb_dl8_v1.csv
def sigmoid(y):
...
if __name__ == '__main__':
    ...
    f.write('patientid,nslice,x,y,diameter,spiculation,label\n')
...
#             patient_data = np.delete(patient_data, 4, 0) # only for luna (remove lobulation)
#             patient_data = np.delete(patient_data, 3, 0) # only for luna (remove malignancy)
#             patient_data = np.delete(patient_data, 2, 0) # only for isbi and luna (remove nodules)
