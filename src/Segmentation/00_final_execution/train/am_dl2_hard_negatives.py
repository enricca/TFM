...
# ARGUMENTS    
parser = argparse.ArgumentParser(description='Train dl2') 
parser.add_argument('-v_dl1', type = str, required=True, help='version of the DL1 model')
parser.add_argument('-v_dl2', type = str, required=True, help='version of the DL2 model')
...
OUTPUT_DL1 = od + 'output/luna_v{}.csv'.format(args.v_dl1)
OUTPUT_DL1_TEST = od + 'output/{}_v{}.csv'.format(args.test_dataset, args.v_dl1)

PATCHES_PATH = wp + 'patches'

OUTPUT_MODEL = od + 'models/patches_hard_negatives_v{}.hdf5'.format(args.v_dl2)
LOGS_PATH = od + 'logs/%s' % 'hard_negatives_v{}'.format(args.v_dl2)
...
if args.train_patches:
    compute_ROIs(args.generate_csv, version_dl2 =args.v_dl2, mode = 'train')
if args.test_patches:
    ...
    compute_ROIs(args.generate_csv, version_dl2 =args.v_dl2, patientTxtPath = testpatientsPath, mode = 'test', dataset = args.test_dataset)

train(args.pretrained_model, args.v_dl2, args.test_dataset)
                 
                 
                 
                 
# Check Nodules Prediction DL1
# nodules_df = pd.read_csv(OUTPUT_DL1)
# th = 0.7
...
# python  am_dl2_hard_negatives.py -v_dl1=3 -v_dl2=1 -train=/media/shared/datasets/LUNA/CSVFILES/patients_train.txt -test=/media/shared/datasets/LUNA/CSVFILES/patients_test.txt --generate_csv
# python  am_dl2_hard_negatives.py -v_dl1=3 -v_dl2=1 -test=/media/shared/datasets/LUNA/CSVFILES/patients_test_isbi.txt --generate_csv

# [No patches generation] 
# python  am_dl2_hard_negatives.py -v_dl1=3 -v_dl2=1
# python  am_dl2_hard_negatives.py -v_dl1=3 -v_dl2=1 -pretrained_model=jm_patches_hardnegative_v03.hdf5

# python  am_dl2_hard_negatives.py -v_dl1=3 -v_dl2=1 --test_patches -test_dataset=isbi --generate_csv
