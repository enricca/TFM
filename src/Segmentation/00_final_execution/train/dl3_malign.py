...
OUTPUT_DL2 = wp + 'output/nodules_patches_dl2_v1_luna.csv'  # OUTPUT_DL1 = wp + 'personal/noduls_patches_v06.csv'
...
OUTPUT_MODEL = wp + 'models/patches_malign_v1.hdf5'  # OUTPUT_MODEL = wp + 'personal/jm_patches_train_v06_local.hdf5'
LOGS_PATH = wp + 'logs/%s' % 'malign_v1' #str(int(time()))
...
common.multiproc_crop_generator(filenames_train,
                                os.path.join(PATCHES_PATH,'dl3_v1_x_train.npz'),
                                os.path.join(PATCHES_PATH,'dl3_v1_y_train.npz'),
                                __load_and_store,
                                parallel=True)


common.multiproc_crop_generator(filenames_test,
                                os.path.join(PATCHES_PATH,'dl3_v1_x_test.npz'),
                                os.path.join(PATCHES_PATH,'dl3_v1_y_test.npz'),
                                __load_and_store,
                                parallel=True)
