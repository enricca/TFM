...
OUTPUT_MODEL = od + 'models/patches_unet_v1.hdf5'  # OUTPUT_MODEL = wp + 'personal/jm_patches_train_v06_local.hdf5'
LOGS_PATH = od + 'logs/%s' % 'patches_unet_v1'
...
filenames = []
with open('/media/shared/datasets/LUNA/CSVFILES/patients_train.txt', 'r') as f:
    for line in f:
        filenames.append(line.strip())
filenames_t = []
with open('/media/shared/datasets/LUNA/CSVFILES/patients_test.txt', 'r') as f:
    for line in f:
        filenames_t.append(line.strip())
...
#
# common.multiproc_crop_generator(filenames_test,
#                                 os.path.join(PATCHES_PATH, 'dl1_v1_x_test.npz'),
#                                 os.path.join(PATCHES_PATH, 'dl1_v1_y_test.npz'),
#                                 __load_and_store)
...
<<<<<<< HEAD
x_train = np.load(os.path.join(PATCHES_PATH, 'dl1_v2_x_train.npz'))['arr_0']
y_train = np.load(os.path.join(PATCHES_PATH, 'dl1_v2_y_train.npz'))['arr_0']
