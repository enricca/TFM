...
# python evaluate_dl6.py -input_model /home/shared/models/lobulation_v1.hdf5 -input_data /media/shared/datasets/LUNA/preprocessed_extra_features/ -output_csv /home/shared/output/luna_dl6_v1.csv
# python evaluate_dl6.py -input_model /home/shared/models/lobulation_v1.hdf5 -input_data /media/shared/datasets/ISBI/preprocessedNew/ -output_csv /home/shared/output/isbi_dl6_v1.csv
# python evaluate_dl6.py -input_model /home/shared/models/lobulation_v1.hdf5 -input_data /media/shared/datasets/DSB/preprocessed_s1/ -output_csv /home/shared/output/dsb_dl6_v1.csv
def sigmoid(y):
...
if __name__ == '__main__':
    ...
    f.write('patientid,nslice,x,y,diameter,lobulation,label\n')
...
#             patient_data = np.delete(patient_data, 5, 0) # only for luna (remove spiculation)
