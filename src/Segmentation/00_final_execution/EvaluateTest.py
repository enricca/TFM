...
if __name__ == '__main__':
    ...
    for pN, patientPath in enumerate(patientFiles):
        try:
            ...
            X, y, rois, statsROIGeneration = common.load_patient(patient_data, discard_empty_nodules=False, output_rois=True, thickness=1, convertToFloat = args.convertToFloat)
